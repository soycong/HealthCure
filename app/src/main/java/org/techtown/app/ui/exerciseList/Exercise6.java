...
public class Exercise6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.exerciselist_exercise6, container, false);

        textView = rootView.findViewById(R.id.textView4);
        textView.setMovementMethod(new ScrollingMovementMethod());
        textView.setScrollY(0);
        videoView = rootView.findViewById(R.id.v6);
        videoView.setMediaController(new MediaController(getActivity()));
        videoView.setVideoURI(Uri.parse("android.resource://"+getActivity().getPackageName()+"/"+R.raw.exercise6));
        ...
        ConstraintLayout constraintLayout =rootView.findViewById(R.id.c6);
